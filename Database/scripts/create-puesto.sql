...
CREATE TABLE IF NOT EXISTS RhPuestoTbl (
	...
	EsRelevante BOOL NOT NULL DEFAULT 0 COMMENT 'Valor lógico que determina si se trata de un puesto relevante',
	EsCritico BOOL NOT NULL DEFAULT 0 COMMENT 'Valor lógico que determina si es un puesto crítico',
